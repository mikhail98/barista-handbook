package com.eratart.baristashandbook.presentation.itemslist.viewmodel
...
class ItemsListViewModel(resourceManager: IResourceManager, appPreferences: IAppPreferences) :
