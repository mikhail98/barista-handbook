package com.eratart.baristashandbook.presentation.itemscategorieslist.viewmodel
...
class ItemsCategoriesListViewModel(
    resourceManager: IResourceManager, appPreferences: IAppPreferences
